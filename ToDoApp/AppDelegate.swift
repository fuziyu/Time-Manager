...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        thirdAction.title = "Third_Action"
        thirdAction.activationMode = UIUserNotificationActivationMode.background
        thirdAction.isDestructive = true
    ...
    func application(_ application: UIApplication, handleActionWithIdentifier identifier: String?, for notification: UILocalNotification, completionHandler: @escaping () -> Void) {
        if(identifier == "FIRST_ACTION") {
            NotificationCenter.default.post(name: Notification.Name(rawValue: "actionOnePressed"), object: notification)
        }else if(identifier == "SECOND_ACTION") {
            NotificationCenter.default.post(name: Notification.Name(rawValue: "actionTwoPressed"), object: notification)
        }
        completionHandler()
    }
